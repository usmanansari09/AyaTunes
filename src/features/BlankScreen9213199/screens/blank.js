  ...
  return (
      ...
      <View style={loginStyle.container}>
          ...
          <View style={loginStyle.footer}>
              <Text style={loginStyle.text_footer}>Verify Email</Text>
              <Text style={loginStyle.text_footer1}>We've sent an code to your email</Text>
              ...
              {/* <Text style={[loginStyle.text_footer, { marginTop: 10 }]}>Password</Text>
              <View style={loginStyle.action}>
                  <FontAwesome
                      name="lock"
                      size={20}
              ...
              <TouchableOpacity style={{alignSelf:'center',flexDirection:'row'}}>
                  <Text style={{ color: '#4caf50', marginTop: 15, }}>Didn't receive any code?</Text>
                  <Text style={{ color: '#4caf50', marginTop: 15, fontWeight:'bold' ,marginLeft:20}}>Resend</Text>
